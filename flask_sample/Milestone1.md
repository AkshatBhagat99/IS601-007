...
<tr><td> <em>Generated: </em> 12/12/2022 10:02:45 PM</td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/AkshatBhagat99/IS601-007/pull/16">https://github.com/AkshatBhagat99/IS601-007/pull/16</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Explain briefly how the process/code works</td></tr>
<tr><td> <em>Response:</em> <p>The user can log in into their accounts through the pages created in<br>html with the id and passwords. And if an invalid user logs in<br>then it will throw error. It uses the data from the database to<br>check if the user is valid or else will show error.<div>The DB helps<br>the system to keep track of the users and the entire data of<br>the website.</div><br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/114647520/207215416-e03fd406-a4f9-423c-9b9f-aaa7f4d34e9d.png"/></td></tr>
