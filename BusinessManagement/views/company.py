...
def add():
    if request.method == "POST":
        ...
        if name=="":
            flash("Please add name", "danger")
            return redirect(url_for("company.add"))
        if address=="":
            flash("Please add address", "danger")
            return redirect(url_for("company.add"))
        if city=="":
            flash("Please add city", "danger")
            return redirect(url_for("company.add"))
        if state=="":
            flash("Please add state", "danger")
            return redirect(url_for("company.add"))
        if country=="":
            flash("Please add Country", "danger")
            return redirect(url_for("company.add"))
